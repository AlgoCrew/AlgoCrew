  ...
  return (
    <>
      <Text onBackground="neutral-weak" variant="body-default-l" marginBottom="m">
        Want to see if we’re the right fit? Let’s work together risk-free. Try us free for 7 days!! just send us an email at {' '} <BlurAnimatedText text="ceo@algocrew.io" />{' '}
          ...
          >
              {about.calendar.display && (
                  <Flex
                      ...
                      data-cal-link="ceo-algocrew/30min"
