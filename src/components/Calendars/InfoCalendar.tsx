...
import AnimatedEmail from "../ui/AnimatedEmail";
import BlurAnimatedText from "../ui/BlurAnimatedText";

export function InfoCalendar() {
  useEffect(() => {
    (async function () {
  ...
  return (
    <>     
      <Text onBackground="neutral-weak" variant="body-default-l" marginBottom="m">
        Ready to move fast and scale smart? Let’s bring your MVP to life! email us at
        {' '}<BlurAnimatedText text="info@algocrew.io" />{' '}
